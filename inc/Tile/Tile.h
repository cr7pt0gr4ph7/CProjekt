...
class Tile
{
	...
	public:
		...
		void rotateccw(void);
		/*!
		 * Gibt den Zeiger auf den Block an der Stelle (x|y) zur�ck.
		 * Hinweis: Wenn die Koordinaten (x|y) au�erhalb der Grenzen der Steinmatrix liegen,
		 * so wird ein neues Blockobjekt erzeugt und der Zeiger hierauf zur�ck gegeben.
		 */
